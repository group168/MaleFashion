        ...
        <div class="panel panel-info">
            <div class="panel-body">
                ...
                <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="list_td aligncenter">
                                    <a href="<?php echo admin_url('transaction/deldetail/'.$value->order_id) ?>"
                                        title="Xóa"> <span class="glyphicon glyphicon-remove"
                                            onclick=" return confirm('Bạn chắc chắn muốn xóa')"></span> </a>
                                </td>
                                <?php
									} ?>
                    ...
                    <?php if ($transaction->status=='0') { ?>
                    <a href="<?php echo admin_url('user/accept/'.$transaction->id); ?>" class="btn btn-success"> Xác
                        nhận đơn hàng</a> <?php
					} ?>
