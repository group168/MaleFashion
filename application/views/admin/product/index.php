...
<div class="panel panel-info">
    <div class="panel-heading">
        ...
        <div class="col-md-2" style="float:right"><a href="<?php echo admin_url('product/add'); ?>"
                class='btn btn-info'><svg class="glyph stroked plus sign">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo base_url(); ?>upload/product/<?php echo $value->image_link; ?>"
                                    alt=""
                                    style="width: 50px;float:left;margin-right: 10px;"><strong><?php echo $value->name; ?></strong>
                                <p style="font-size: 12px;margin-top: 4px;">View: <?php echo $value->view; ?> <span> |
                                        Đã bán :<?php echo $value->buyed; ?></span></p>
                            </td>
                            ...
                            <td style="vertical-align: middle">
                                <?php
                                    if ($value->discount > 0) {
                                        ...
                                        ?>
                                <strong><?php echo number_format($price_new); ?>
                                    VNĐ</strong><br><del><?php echo number_format($value->price); ?> VNĐ</del>
                            ...
                            <td class="list_td aligncenter">
                                <a href="<?php echo admin_url('product/edit/' . $value->id); ?>" title="Sửa"><span
                                        class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;&nbsp;
                                <a id="<?php echo $value->id; ?>" title="Xóa" class="remove"
                                    onclick=" return confirm('Xóa sản phẩm sẽ đặt số lượng bằng 0')"> <span
