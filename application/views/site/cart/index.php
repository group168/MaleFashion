<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 clearpaddingr">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>
                    Trang chủ</a></li>
            <li class="active">Chi tiết giỏ hàng</li>
        </ol>
        <?php if (isset($message) && !empty($message)) { ?>
        <h5 style="color:#ffffff;margin-top: 10px;background-color: rgb(238, 77, 45);padding: 15px;">
            <?php echo $message; ?></h5>
        <?php
        }
        if ($total_items > 0) {
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="<?php echo base_url('upload/product/' . $items['image_link']); ?>"
                                    class="img-thumbnail" alt="" style="width: 50px;"></td>
                            <td style="min-width: 150px;text-align: center"><a class="cart-sumsub"
                            ...
                            <td style="min-width: 150px;padding-left: 40px">
                                <a class="cart-sumsub"
                                    href="<?php echo base_url('cart/sumsize/' . $items['cartid'] . '/' . $items['id']); ?>">-</a>
                                <input type="hidden" value="<?php echo $items['size']; ?>"
                            ...
                            <td style="text-align: center"><a style="color: #00FF00"
                                    href="<?php echo base_url('cart/newsize/' . $items['id']); ?>"><span
                                        class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span></a></td>
                            <td><?php echo number_format($items['subtotal']); ?> VNĐ</td>
                            <td><a style="color: red"
                                    href="<?php echo base_url('cart/del/' . $items['cartid']); ?>"><span
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold;color:green"><?php echo number_format($total_price); ?> VNĐ
                            </td>
                            <td><a style="font-weight: bold;color: red" href="<?php echo base_url('cart/del'); ?>">Xóa
                                    toàn bộ</a></td>

                        </tr>
                        <tr style="border: none">
                            <td colspan="8"><a style="float: right;;border: none"
                                    href="<?php echo base_url('order'); ?>" class="btn btn-success">Đặt mua</a></td>
                        </tr>
